        ...
        <section className="lista">
            ...
            <div className="tarjetas-container">
                {productos.map((producto) => (
                    <a key={producto.id} className='tarjeta' href={`/producto/${producto.id}`}>
                        <img src={producto.imagenes[0]} alt={producto.nombre} />
                        <div>{'★'.repeat(Math.round(producto.resenas.reduce((acc, r) => acc + r.estrellas, 0) / producto.resenas.length) || 5)}</div>
